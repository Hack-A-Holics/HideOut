...
public class BookmarksActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nav_bookmarks);
        ...
        PropertyAdapter adapter = new PropertyAdapter(BookmarksActivity.this, locations);
        ListView listView = findViewById(R.id.list_view_wishList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent i = new Intent(BookmarksActivity.this, DetailsActivity.class);
                startActivity(i);
            }
...
//        getMenuInflater().inflate(R.menu.logout, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            ...
            Intent i = new Intent(BookmarksActivity.this, AddNewPropertyActivity.class);
            startActivity(i);
            return true;
        }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        int id = item.getItemId();
        if (id == R.id.home) {
            Intent i = new Intent(BookmarksActivity.this, HomeActivity.class);
            startActivity(i);
        } else if (id == R.id.myProperty) {
            Intent i = new Intent(BookmarksActivity.this, MyPropertiesActivity.class);
            startActivity(i);
            ...
            Intent i = new Intent(BookmarksActivity.this, FeedbackActivity.class);
            startActivity(i);
